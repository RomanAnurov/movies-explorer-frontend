...
function Navigation(props) {
  ...
  return (
    <nav className={`navigation  ${isOpen && "navigation_type_visible"}`}>
      ...
      <NavLink to="/saved-movies" onClick={onClose} className={({isActive}) =>`navigation__link ${isActive ? "navigation__link_active" : ''}`} >Сохранённые фильмы</NavLink>
